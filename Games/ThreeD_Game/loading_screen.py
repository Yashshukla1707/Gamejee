...
class ThreeDGameLoadingScreen(Screen):
    def __init__(self , **kwargs):
        super().__init__(**kwargs)
        layout = FloatLayout()
        bg = Image(
            source="Images/3DGameLoadingScreenLogo.jpg", opacity=0.5, allow_stretch=True, keep_ratio=False
        )
    ...
    def go_home(self , instance):
        self.manager.current = "3D_game_home_screen"
