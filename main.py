...
from Games.GraphGame.loading_screen import GraphGameLoadingScreen
from Games.GraphGame.home_screen import GraphGameHomeScreen
from Games.GraphGame.level_screen import GraphGameLevelScreen
from Games.GraphGame.graph_screen import GraphGameScreen
from Games.GraphGame.main_game_screen import GraphGameMainGameScreen
from Games.ThreeD_Game.home_screen import ThreeDGameHomeScreen
from Games.ThreeD_Game.loading_screen import ThreeDGameLoadingScreen
from Games.ThreeD_Game.rotating_test import RotatorScreen
...
class MyApp(App):
    def build(self):
        ...
        sm.add_widget(ShootingGameLoadingScreen(name = "shooting_game_loading_screen"))
        sm.add_widget(ShootingGameHomeScreen(name = "shooting_game_home_screen"))
        sm.add_widget(ShootingGameLevelScreen(name = "shooting_game_level_screen"))
        sm.add_widget(ShootingGameMainGameScreen(name = "shooting_game_main_game_screen"))
        sm.add_widget(GraphGameLoadingScreen(name = "graph_game_loading_screen"))
        sm.add_widget(GraphGameHomeScreen(name = "graph_game_home_screen"))
        sm.add_widget(GraphGameLevelScreen(name = "graph_game_level_screen"))
        sm.add_widget(GraphGameScreen(name = "graph_game_screen"))
        sm.add_widget(GraphGameMainGameScreen(name = "graph_game_main_game_screen"))
        sm.add_widget(ThreeDGameLoadingScreen(name = "3D_game_loading_screen"))
        sm.add_widget(ThreeDGameHomeScreen(name= "3D_game_home_screen"))
        sm.add_widget(RotatorScreen(name = "3D_rotating_game_screen"))
